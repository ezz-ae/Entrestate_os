...
const SEO_COPY: Record<AppLocale, { defaultTitle: string; defaultDescription: string; homeTitle: string; homeDescription: string; ogAlt: string }> = {
  ...
  ar: {
    defaultTitle: "Entrestate | منصة ذكاء الاستثمار العقاري في الإمارات",
    defaultDescription:
      "حلّل أسواق العقارات في الإمارات عبر تقييمات مدعومة بالأدلة، مؤشرات موثوقية المطورين، وأدوات استثمارية احترافية.",
    homeTitle: "ذكاء القرار الاستثماري في الإمارات",
    homeDescription:
      "حلّل أسواق العقارات في الإمارات عبر تقييمات مدعومة بالأدلة، مؤشرات موثوقية المطورين، وأدوات استثمارية احترافية.",
