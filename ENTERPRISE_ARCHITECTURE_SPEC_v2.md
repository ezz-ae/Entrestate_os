...
| get_folder_detail | SDR ID | Full Structured Deal Record + audit trail |
...
- **7,217 leasing folders** from live intake with geocoverage (lat/lng)
- **36,841 DLD transactions** (Dubai Land Department — real sales data)
- **75 developers** in a tiered registry with logos, project counts, reliability scores
- **167 area benchmarks** from live market data
