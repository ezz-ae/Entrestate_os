...
const T = {
  ...
  ar: {
    ...
    cancel:             "إلغاء",
    subject:            "الموضوع",
    chat:               "محادثة الذكاء السوقي",
    sourcesActive:      "مصادر نشطة",
    askYourBook:        "اسأل كتاب السوق الخاص بك",
    chatSubtitle:       "مدعوم بمصادرك وذكاء إنتريستيت القراري",
    ...
    errorMsg:           "تعذر الوصول إلى محرك الذكاء. حاول مجدداً.",
    doneMsg:            "اكتمل تحليل الذكاء.",
...
const OUTPUT_DEFS: OutputDef[] = [
  ...
  },
  {
    ...
    descAr:  "ملخص ذكاء منطوق — ملخص سوقي في صيغة صوتية",
