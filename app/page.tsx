  ...
  return locale === "ar"
    ? [
        ...
        },
        {
          icon: Map,
          label: "المناطق",
          description: "متوسطات العائد وضغط المعروض وعمق التسعير وأبرز المشاريع في كل منطقة داخل الإمارات.",
          href: "/areas",
          cta: "استكشف المناطق",
        ...
        },
        {
          icon: TrendingUp,
          label: "السوق",
          description: "إشارات التوقيت الحية وترتيب المناطق وموثوقية المطورين في لوحة واحدة.",
          href: "/top-data",
          cta: "عرض الإشارات",
