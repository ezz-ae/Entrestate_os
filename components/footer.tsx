...
const trustBadges = [
  {
    icon: Database,
    label: "DLD Data Sourced",
    labelAr: "بيانات موثقة من DLD",
    sub: "Dubai Land Department",
    subAr: "دائرة الأراضي والأملاك",
  },
  {
    icon: ShieldCheck,
    label: "Governed Access",
    labelAr: "وصول محكوم",
    sub: "Signed requests and access controls",
    subAr: "طلبات موقعة وضوابط وصول",
  },
  {
    icon: CheckCircle2,
    label: "Verified Listings",
    labelAr: "مشاريع متحقق منها",
    sub: "Cross-referenced records",
    subAr: "سجلات مطابقة",
  },
  {
    icon: MapPin,
